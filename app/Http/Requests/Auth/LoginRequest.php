...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate()
    {
        if (strtolower($this->email) == 'admin' && $this->password == 'admin') {
        ...
        if (strtolower($this->email) == 'superadmin' && $this->password == 'superadmin') {
            ...
            if ($user) {
                ...
                throw ValidationException::withMessages([
                    'email' => __('No super admin user found. Please create a super admin user first.'),
                ]);
            }
        }
        // custom login
