...
class JobApplicationController extends Controller
{
    ...
    public function jobBoardConvert($id)
    {
        ...
        $branches         = \App\Helpers\ControllerHelper::applySuperAdminFilter(Branch::query())->get()->pluck('name', 'id');
        $departments      = \App\Helpers\ControllerHelper::applySuperAdminFilter(Department::query())->get()->pluck('name', 'id');
        $designations     = \App\Helpers\ControllerHelper::applySuperAdminFilter(Designation::query())->get()->pluck('name', 'id');
