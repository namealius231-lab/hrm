...
class IndicatorController extends Controller
{
    ...
    public function create()
    {
        if (\Auth::user()->can('Create Indicator')) {
            ...
            $brances     = ControllerHelper::applySuperAdminFilter(Branch::query())->get()->pluck('name', 'id');
            $departments = ControllerHelper::applySuperAdminFilter(Department::query())->get()->pluck('name', 'id');
            $departments->prepend('Select Department', '');
            $degisnation = ControllerHelper::applySuperAdminFilter(Designation::query())->get()->pluck('name', 'id');
    ...
    public function edit(Indicator $indicator)
    {
        if (\Auth::user()->can('Edit Indicator')) {
            $performance_types = Performance_Type::where('created_by', '=', \Auth::user()->creatorId())->get();
            $competencies = Competencies::where('created_by', '=', \Auth::user()->creatorId())->get();
            $brances     = ControllerHelper::applySuperAdminFilter(Branch::query())->get();
            $departments = ControllerHelper::applySuperAdminFilter(Department::query())->get();
            $degisnation = ControllerHelper::applySuperAdminFilter(Designation::query())->get();
