...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public static function defaultEmail()
    {
        ...
        $defaultTemplate = [
            ...
            'new_leave_request' => [
                ...
                'lang' => [
                    'ar' => '<p><span style="font-family: sans-serif;"><strong>موضوع:</strong> طلب إجازة جديد </span></p>
                    <p><span style="font-family: sans-serif;">موظف {employee_name} تقدم بطلب للحصول على إجازة. هنا التفاصيل:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>ترك نوع:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>ترك المدة:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>سبب:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">شكرًا لك,</span></p>
                    <p><span style="font-family: sans-serif;">قسم الموارد البشرية,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'da' => '<p><span style="font-family: sans-serif;"><strong>Emne:</strong> Ny orlovsanmodning </span></p>
                    <p><span style="font-family: sans-serif;">Medarbejder {employee_name} har ansøgt om orlov. Her er detaljerne:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Forlad type:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Efterlad varighed:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Årsag:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Tak,</span></p>
                    <p><span style="font-family: sans-serif;">HR -afdeling,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'de' => '<p><span style="font-family: sans-serif;"><strong>Thema:</strong> Neue Urlaubsanfrage </span></p>
                    <p><span style="font-family: sans-serif;">Mitarbeiter {employee_name} hat beantragt. Hier sind die Details:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Typ lassen:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Dauer verlassen:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Grund:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Danke,</span></p>
                    <p><span style="font-family: sans-serif;">Personalabteilung,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    ...
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'es' => '<p><span style="font-family: sans-serif;"><strong>Sujeto:</strong> Nueva solicitud de licencia </span></p>
                    <p><span style="font-family: sans-serif;">Empleado {employee_name} ha solicitado licencia. Aquí están los detalles:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Tipo de licencia:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Duración de licencia:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Razón:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Gracias,</span></p>
                    <p><span style="font-family: sans-serif;">Departamento de recursos humanos,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'fr' => '<p><span style="font-family: sans-serif;"><strong>Sujet:</strong> Nouvelle demande de congé </span></p>
                    <p><span style="font-family: sans-serif;">Employé {employee_name} a demandé un congé. Voici les détails:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Type de congé:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Laisser la durée:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Raison:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Merci,</span></p>
                    <p><span style="font-family: sans-serif;">Département des ressources humaines,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'he' => '<p><span style="font-family: sans-serif;"><strong>נוֹשֵׂא:</strong> בקשת חופשה חדשה </span></p>
                    <p><span style="font-family: sans-serif;">עוֹבֵד {employee_name} הגיש בקשה לחופשה. להלן הפרטים:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>סוג לעזוב:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>השאירו משך זמן:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>לְנַמֵק:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">תודה,</span></p>
                    <p><span style="font-family: sans-serif;">מחלקת משאבי אנוש,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'it' => '<p><span style="font-family: sans-serif;"><strong>Soggetto:</strong> Nuova richiesta di congedo </span></p>
                    <p><span style="font-family: sans-serif;">Dipendente {employee_name} ha richiesto un congedo. Ecco i dettagli:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Lasciare il tipo:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Lasciare la durata:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Motivo:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Grazie,</span></p>
                    <p><span style="font-family: sans-serif;">Dipartimento delle risorse umane,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'ja' => '<p><span style="font-family: sans-serif;"><strong>主題:</strong> 新しい休暇リクエスト </span></p>
                    <p><span style="font-family: sans-serif;">従業員 {employee_name} 休暇を申請しました。ここに詳細があります:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>タイプを残します:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>休暇期間:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>理由:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">ありがとう,</span></p>
                    <p><span style="font-family: sans-serif;">HR部門,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'nl' => '<p><span style="font-family: sans-serif;"><strong>Onderwerp:</strong> Nieuw verlofverzoek </span></p>
                    <p><span style="font-family: sans-serif;">Medewerker {employee_name} heeft verlof aangevraagd. Hier zijn de details:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Laat het type:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>De duur verlaat:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Reden:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Bedankt,</span></p>
                    <p><span style="font-family: sans-serif;">HR -afdeling,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pl' => '<p><span style="font-family: sans-serif;"><strong>Temat:</strong> Nowa prośba o urlop </span></p>
                    <p><span style="font-family: sans-serif;">Pracownik {employee_name} złożył wniosek o urlop. Oto szczegóły:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Wyjdź typ:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Pozostaw czas trwania:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Powód:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Dziękuję,</span></p>
                    <p><span style="font-family: sans-serif;">Departament HR,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pt' => '<p><span style="font-family: sans-serif;"><strong>Assunto:</strong> Nova solicitação de licença </span></p>
                    <p><span style="font-family: sans-serif;">Funcionário {employee_name} solicitou licença. Aqui estão os detalhes:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Sair do tipo:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Deixe duração:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Razão:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Obrigado,</span></p>
                    <p><span style="font-family: sans-serif;">Departamento de RH,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pt-br' => '<p><span style="font-family: sans-serif;"><strong>Assunto:</strong> Nova solicitação de licença </span></p>
                    <p><span style="font-family: sans-serif;">Funcionário {employee_name} solicitou licença. Aqui estão os detalhes:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Sair do tipo:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Deixe duração:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Razão:</strong>{leave_reason}</span></p>
                    ...
                    <p><span style="font-family: sans-serif;">Departamento de RH,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'ru' => '<p><span style="font-family: sans-serif;"><strong>Предмет:</strong> Новый запрос на отпуск </span></p>
                    <p><span style="font-family: sans-serif;">Сотрудник {employee_name} подал заявку на отпуск. Вот подробности:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Оставить тип:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Оставить продолжительность:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Причина:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Спасибо,</span></p>
                    <p><span style="font-family: sans-serif;">Отдел кадров,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;"><strong>Ders:</strong> Yeni izin isteği </span></p>
                    <p><span style="font-family: sans-serif;">Çalışan {employee_name} izin için başvurdu. İşte detaylar:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Ayrılma Türü:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Ayrılma Süresi:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Sebep:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">Teşekkür ederim,</span></p>
                    <p><span style="font-family: sans-serif;">İK departmanı,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'zh' => '<p><span style="font-family: sans-serif;"><strong>主题:</strong> 新的请假请求 </span></p>
                    <p><span style="font-family: sans-serif;">员工 {employee_name} 已申请休假。这是细节:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>离开类型:</strong> {leave_type}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>离开持续时间:</strong> {leave_start_end_time}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>原因:</strong>{leave_reason}</span></p>
                    <p><span style="font-family: sans-serif;">谢谢,</span></p>
                    <p><span style="font-family: sans-serif;">人力资源部门,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                ],
            ],
        ];
    ...
    public static function userDefaultData()
    {
        ...
        $users = User::where('type', '=', 'company')->get()->pluck('id');
        foreach ($users as $key => $user) {
            foreach ($allEmail as $email) {
                $emailNoti = UserEmailTemplate::where('template_id', $email->id)->where('user_id', $user)->count();
                if ($emailNoti == 0) {
    ...
    public function userDefaultDataRegister($user_id)
    {
        ...
        $allEmail = EmailTemplate::all();
        foreach ($allEmail as $email) {
            $emailNoti = UserEmailTemplate::where('template_id', $email->id)->where('user_id', $user_id)->count();
            if ($emailNoti == 0) {
                UserEmailTemplate::create(
                    [
                        'template_id' => $email->id,
