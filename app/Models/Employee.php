...
class Employee extends Model
{
    ...
    {
        return $this->hasMany(EmployeePositionAssignment::class, 'employee_id');
    }

    public function performanceAssignments()
    {
        return $this->hasMany(PerformanceTaskAssignment::class, 'employee_id');
    }
