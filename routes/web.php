...
use App\Http\Controllers\Performance\PerformanceTaskController;
use App\Http\Controllers\Performance\PerformanceTaskUpdateController;
use App\Http\Controllers\Performance\PerformanceAnalyticsController;
use App\Http\Controllers\Performance\PerformanceCommunicationController;
use App\Http\Controllers\Performance\PerformanceReviewController;
use App\Http\Controllers\Performance\OrgRoleController;
use App\Http\Controllers\Performance\OrgPositionController;
use App\Http\Controllers\Performance\EmployeePositionAssignmentController;
...
Route::group(['middleware' => ['verified', 'auth', 'XSS']], function () {
    Route::resource('performance-tasks', PerformanceTaskController::class);

    Route::post(
        'performance-assignments/{performanceTaskAssignment}/updates',
        [PerformanceTaskUpdateController::class, 'store']
    )->name('performance-assignments.updates.store');
    Route::post(
        'performance-assignments/{performanceTaskAssignment}/reviews',
        [PerformanceReviewController::class, 'store']
    )->name('performance-assignments.reviews.store');
    Route::delete(
        'performance-reviews/{performanceReview}',
        [PerformanceReviewController::class, 'destroy']
    )->name('performance-reviews.destroy');

    Route::get('performance-pulse', [PerformanceAnalyticsController::class, 'index'])->name('performance.pulse.index');
    Route::get('performance-pulse/employee', [PerformanceAnalyticsController::class, 'employee'])->name('performance.pulse.employee');
    Route::get('performance-pulse/charts', [PerformanceAnalyticsController::class, 'chartData'])->name('performance.pulse.charts');
    Route::post('performance-pulse/insights', [PerformanceAnalyticsController::class, 'generateInsight'])->name('performance.pulse.insight');

    Route::post('performance-communication/direct', [PerformanceCommunicationController::class, 'directMessage'])->name('performance.communication.direct');
    Route::post('performance-communication/announcement', [PerformanceCommunicationController::class, 'announcement'])->name('performance.communication.announcement');
    Route::post('performance-communication/meeting', [PerformanceCommunicationController::class, 'meeting'])->name('performance.communication.meeting');

    Route::resource('org-roles', OrgRoleController::class)->except('show');
    Route::resource('org-positions', OrgPositionController::class)->only(['index', 'store', 'update', 'destroy']);

    Route::post('employee-position-assignments', [EmployeePositionAssignmentController::class, 'store'])->name('employee-position-assignments.store');
    Route::put('employee-position-assignments/{employeePositionAssignment}', [EmployeePositionAssignmentController::class, 'update'])->name('employee-position-assignments.update');
    Route::delete('employee-position-assignments/{employeePositionAssignment}', [EmployeePositionAssignmentController::class, 'destroy'])->name('employee-position-assignments.destroy');
});
        }
    );
