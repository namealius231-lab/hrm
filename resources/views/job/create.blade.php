                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control editor summernote-simple-2" name="description" id="description" rows="3" required></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            @endif
                            <textarea class="form-control editor summernote-simple" name="requirement" id="requirement" rows="3" required></textarea>
