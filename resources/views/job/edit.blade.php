                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {{ Form::select('branch', $branches,null, array('class' => 'form-control select','required'=>'required', 'placeholder' => __('Select Branch'))) }}
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-12">
                             <label class="col-form-label" for="skill">{{ __('Skill Box') }}<x-required></x-required>
