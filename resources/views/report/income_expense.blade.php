                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="btn-box">
                                        ...
                                        {{ Form::month('start_month', isset($_GET['start_month']) ? $_GET['start_month'] : date('Y-m'), ['class' => 'month-btn form-control', 'autocomplete' => 'off', 'placeholder' => 'Select start month']) }}
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="btn-box">
                                        {{ Form::label('end_month', __('End Month'), ['class' => 'form-label']) }}
                                        {{ Form::month('end_month', isset($_GET['end_month']) ? $_GET['end_month'] : date('Y-m'), ['class' => 'month-btn form-control', 'autocomplete' => 'off', 'placeholder' => 'Select end month']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
