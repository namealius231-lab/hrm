                                ...
                                <tr>
                                    ...
                                    <td>
                                         @if ($training->status == 0)
                                            <span class="badge bg-warning p-2 px-3  mt-1 status-badge6">{{ __($status[$training->status]) }}</span>
                                        @elseif($training->status == 1)
                                            <span class="badge bg-primary p-2 px-3  mt-1 status-badge6">{{ __($status[$training->status]) }}</span>
                                        @elseif($training->status == 2)
                                            <span class="badge bg-success p-2 px-3  mt-1 status-badge6">{{ __($status[$training->status]) }}</span>
                                        @elseif($training->status == 3)
                                            <span class="badge bg-danger p-2 px-3  mt-1 status-badge6">{{ __($status[$training->status]) }}</span>
                                        @endif
