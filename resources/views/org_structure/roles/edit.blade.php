    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">{{ $orgRole->name }}</h5>
            </div>
            <div class="card-body">
                {!! Form::model($orgRole, ['route' => ['org-roles.update', $orgRole], 'method' => 'PUT']) !!}
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="reports_to_role_id" class="form-select">
                            ...
                            @foreach ($roles as $role)
                                <option value="{{ $role->id }}" @selected($orgRole->reports_to_role_id == $role->id)>
                                    {{ $role->name }}
                                </option>
                            @endforeach
                        </select>
