                                                    ...
                                                    <span class="float-start">
                                                        @can('Edit Income Type')
                                                            <div class="action-btn me-2">
                                                                <a href="#" class="btn btn-sm align-items-center bg-info"
                                                                    data-url="{{ route('incometype.edit', $incometype->id) }}"
                                                                    data-ajax-popup="true" data-title="{{ __('Edit Income Type') }}"
                                                        ...
                                                        @can('Delete Income Type')
                                                            <div class="action-btn ">
                                                                {!! Form::open([
                                                                    'method' => 'DELETE',
                                                                    'route' => ['incometype.destroy', $incometype->id],
                                                                    'id' => 'delete-form-' . $incometype->id,
                                                                    ]) !!}
                                                                    <a href="#"
