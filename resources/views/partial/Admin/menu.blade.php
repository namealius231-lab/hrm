...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            <!-- performance-->
            @if (Gate::check('Manage Indicator') || Gate::check('Manage Appraisal') || Gate::check('Manage Goal Tracking') || Gate::check('Manage Performance Pulse') || \Auth::user()->type == 'employee')
                <li class="dash-item dash-hasmenu">
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                    ...
                    <ul class="dash-submenu">
                        @can('Manage Performance Pulse')
                            <li class="dash-item">
                                <a class="dash-link"
                                    href="{{ route('performance.pulse.index') }}">{{ __('Performance Pulse') }}</a>
                            </li>
                        @endcan
                        <li class="dash-item">
                            <a class="dash-link"
                                href="{{ route('performance-tasks.index') }}">{{ __('Task Board') }}</a>
                        </li>
                        @if (\Auth::user()->type == 'employee')
                            <li class="dash-item">
                                <a class="dash-link"
                                    href="{{ route('performance.pulse.employee') }}">{{ __('My Pulse') }}</a>
                            </li>
                        @endif
            ...
            @can('Manage Org Hierarchy')
                <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'org-roles' || Request::segment(1) == 'org-positions' ? 'dash-trigger active' : '' }}">
                    <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-hierarchy-2"></i></span><span
                            class="dash-mtext">{{ __('Org Hierarchy') }}</span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="dash-submenu">
                        <li class="dash-item">
                            <a class="dash-link" href="{{ route('org-roles.index') }}">{{ __('Roles') }}</a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link" href="{{ route('org-positions.index') }}">{{ __('Positions & Reporting') }}</a>
                        </li>
                    </ul>
                </li>
            @endcan
            ...
            @if (\Auth::user()->type == 'super admin' && Route::has('plan_request.index'))
                <li class="dash-item ">
            ...
            @if (Auth::user()->type == 'super admin')
                ...
                @endif
            @endif
            {{-- Order menu item commented out - route order.index does not exist --}}
            {{-- @if (\Auth::user()->type == 'super admin')
