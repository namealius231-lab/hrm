                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody class="list">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="3" class="text-center text-muted">{{ __('No meetings scheduled') }}</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody class="list">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="2" class="text-center text-muted">{{ __('All employees have clocked in today') }}</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
...
@push('script-page')
    ...
    <script type="text/javascript">
        ...
        function initCharts() {
            ...
            var statisticsChartEl = document.querySelector("#statistics-chart");
            var jobsChartEl = document.querySelector("#jobs-chart");
            
            if (!statisticsChartEl || !jobsChartEl) {
            ...
            var statisticsOptions = {
                ...
                xaxis: {
                    categories: ['{{ __('Staff') }}', '{{ __('Tickets') }}', '{{ __('Total Jobs') }}', '{{ __('Active Jobs') }}', '{{ __('Inactive Jobs') }}'],
                },
                yaxis: {
                    title: {
                        text: '{{ __('Count') }}'
                ...
                colors: ['#5e72e4', '#11cdef', '#fb6340', '#2dce89', '#f5365c'],
                tooltip: {
                    y: {
            ...
            var statisticsChart = new ApexCharts(statisticsChartEl, statisticsOptions);
            statisticsChart.render();

            // Jobs Status Pie Chart
            var jobsOptions = {
                series: [{{ $activeJob }}, {{ $inActiveJOb }}],
                chart: {
                    type: 'donut',
                    height: 300
                },
                labels: ['{{ __('Active Jobs') }}', '{{ __('Inactive Jobs') }}'],
            ...
            var jobsChart = new ApexCharts(jobsChartEl, jobsOptions);
            jobsChart.render();
        }
        ...
        function get_data() {
            ...
            calendarEl.removeClass('local_calender');
            calendarEl.removeClass('google_calender');
            if (calender_type == undefined) {
                calender_type = 'local_calender';
            }
            calendarEl.addClass(calender_type);
    ...
    <script>
        ...
        function get_data() {
            var calendarEl = $('#event_calendar');
            if (calendarEl.length === 0) {
                console.warn("Event calendar element not found");
                return;
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    (function() {
                        ...
                        if (!calendarEl) {
                            console.error("Event calendar element not found");
                            return;
                        }
